...
Our evaluation results show that the proposed approach achieves similar performance when compared to less space efficient schemes using separate neuronal networks for differing channel conditions.   
...
Hyperspectral images include infrared and other bands, which can be used to monitor vegetation, clouds, and other phenomena. % not represented in the visible light spectrum.
...
Considering more complex channel models %including multi-path propagation, shadowing, and fading 
