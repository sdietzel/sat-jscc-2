...
For the channel, we assume a log-normal distribution with mean $\alpha$ and standard deviation $\psi$, a Rayleigh-distributed multipath component \MP, and a signal-to-noise parameter \SNR.
