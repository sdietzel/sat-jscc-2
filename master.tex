...
\begin{figure}[t!]
  \begin{subfigure}{.3\linewidth}
  \centering
  \include{plots/plt_no_af_40_los.tex}
  \vspace{-2.5em}
  \caption{LOS}
\end{subfigure}
\vspace{1ex}
\begin{subfigure}{.3\linewidth}
  \centering
  \include{plots/plt_no_af_40_shadow.tex}
  \vspace{-2.5em}
  \caption{Shadow}
\end{subfigure}
\vspace{1ex}
\begin{subfigure}{.3\linewidth}
  \centering
  \include{plots/plt_no_af_40_deep_shadow.tex}
  \vspace{-2.5em}
  \caption{Deep shadow}
\end{subfigure}
...
\begin{figure}[t!]
  \begin{subfigure}{.3\linewidth}
  \centering
  \include{plots/plt_el_angle_0.04_los.tex}
  \vspace{-2.5em}
  \caption{LOS}
\end{subfigure}
\vspace{1ex}
\begin{subfigure}{.3\linewidth}
  \centering
  \include{plots/plt_el_angle_0.04_shadow.tex}
  \vspace{-2.5em}
  \caption{Shadow}
\end{subfigure}
\vspace{1ex}
\begin{subfigure}{.3\linewidth}
  \centering
  \include{plots/plt_el_angle_0.04_deep_shadow.tex}
  \vspace{-2.5em}
  \caption{Deep shadow}
\end{subfigure}
...
\begin{figure}[t!]
  \begin{subfigure}{.3\linewidth}
  \centering
  \include{plots/plt_el_angle_0.33_los.tex}
  \vspace{-2.5em}
  \caption{LOS}
\end{subfigure}
\vspace{1ex}
\begin{subfigure}{.3\linewidth}
  \centering
  \include{plots/plt_el_angle_0.33_shadow.tex}
  \vspace{-2.5em}
  \caption{Shadow}
\end{subfigure}
\vspace{1ex}
\begin{subfigure}{.3\linewidth}
  \centering
  \include{plots/plt_el_angle_0.33_deep_shadow.tex}
  \vspace{-2.5em}
  \caption{Deep shadow}
\end{subfigure}
...
The results for compression rates $0.04$ and $0.33$ are presented in \Cref{fig:elevation_angles_0.04} and \Cref{fig:elevation_angles_0.33}.
...
\begin{figure}[t!]
  ...
  \centering
  \include{plots/plt_af_vs_no_af_urban_40.tex}
  \vspace{-2.5em}
...
\begin{subfigure}{.45\linewidth}
  \centering
  \include{plots/plt_af_vs_no_af_urban_80.tex}
  \vspace{-2.5em}
...
\begin{figure}[t!]
  \begin{subfigure}{.45\linewidth}
  \centering
  \include{plots/plt_los_instead_of_deep_shadow_urban.tex}
  \vspace{-2.5em}
...
\begin{subfigure}{.45\linewidth}
  \centering
  \include{plots/plt_deep_shadow_instead_of_los_urban.tex}
  \vspace{-2.5em}
