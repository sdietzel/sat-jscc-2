\begin{tikzpicture}
    ...
    \begin{axis}[
      ...
      \addplot[bar shift=5pt,fill=tol1!33] coordinates { (open, 68.05071847613172) };
      ...
      \addplot[bar shift=5pt,fill=tol2!33] coordinates { (suburban, 65.61713528754578) };
      ...
      \addplot[bar shift=5pt,fill=tol3!33] coordinates { (intermediate tree-shadow, 63.182928753310684) };
      
      \addplot[%nodes near coords=$1.26$,
        bar shift=-5pt,fill=tol1!66,postaction={
        pattern=north east lines, pattern color=black
    }] coordinates { (heavy tree-shadow, 60.80235241808859) };
      \addplot[bar shift=5pt,fill=tol1!66] coordinates { (heavy tree-shadow, 62.51972868765633) };
      
      \addplot[%nodes near coords=$1.17$,
        bar shift=-5pt,fill=tol2!66,postaction={
        pattern=north east lines, pattern color=black
    }] coordinates { (urban, 62.73554608081638) };
      \addplot[bar shift=5pt,fill=tol2!66] coordinates { (urban, 62.9654737199328) };
