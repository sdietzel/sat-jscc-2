\begin{tikzpicture}
    ...
    \begin{axis}[
      ...
      \addplot[bar shift=5pt,fill=tol1!33] coordinates { (open, 67.76665563361574) };
      ...
      \addplot[bar shift=5pt,fill=tol2!33] coordinates { (suburban, 64.41231830717751) };
      ...
      \addplot[bar shift=5pt,fill=tol3!33] coordinates { (intermediate tree-shadow, 63.39092156973394) };
      
      \addplot[%nodes near coords=$1.26$,
        bar shift=-5pt,fill=tol1!66,postaction={
        pattern=north east lines, pattern color=black
    }] coordinates { (heavy tree-shadow, 57.512479690636944) };
      \addplot[bar shift=5pt,fill=tol1!66] coordinates { (heavy tree-shadow, 60.45771389019385) };
      
      \addplot[%nodes near coords=$1.17$,
        bar shift=-5pt,fill=tol2!66,postaction={
        pattern=north east lines, pattern color=black
    }] coordinates { (urban, 57.03474187203291) };
      \addplot[bar shift=5pt,fill=tol2!66] coordinates { (urban, 62.0518730036318) };
