\begin{tikzpicture}
    ...
    \begin{axis}[
      ...
      \addplot[bar shift=5pt,fill=tol1!33] coordinates { (open, 60.941951355437276) };
      ...
      \addplot[bar shift=5pt,fill=tol2!33] coordinates { (suburban, 61.017142451016966) };
      ...
      \addplot[bar shift=5pt,fill=tol3!33] coordinates { (intermediate tree-shadow, 60.14165345147827) };
      
      \addplot[%nodes near coords=$1.26$,
        bar shift=-5pt,fill=tol1!66,postaction={
        pattern=north east lines, pattern color=black
    }] coordinates { (heavy tree-shadow, 52.84660367941581) };
      \addplot[bar shift=5pt,fill=tol1!66] coordinates { (heavy tree-shadow, 55.73117874454389) };
      
      \addplot[%nodes near coords=$1.17$,
        bar shift=-5pt,fill=tol2!66,postaction={
        pattern=north east lines, pattern color=black
    }] coordinates { (urban, 50.84575762551614) };
      \addplot[bar shift=5pt,fill=tol2!66] coordinates { (urban, 57.86157808541486) };
